  ...
  },
  {
    ...
    controls: [
      { key: "mode", label: "Style", type: "select", options: [
        { value: "reveal", label: "Reveal (zoom into → out to full sentence)" },
        { value: "loop", label: "Loop (continuous scroll)" },
      ] },
      { key: "segments", label: "Words — one per line: TEXT | size | color | italic  (add | focus to mark the zoom word)", type: "textarea", placeholder: "ever wanted | 10\nto | 3.5\nmake | 4 | accent\nvisually | 16 | accent\nbeautiful | 12 | | italic\nmotion | 7 | accent\ntypography? | 12 | | focus" },
      { key: "fontKey", label: "Font", type: "select", options: FONT_SELECT },
